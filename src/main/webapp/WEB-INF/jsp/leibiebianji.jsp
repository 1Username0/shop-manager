  ...
  <script>
    $(function(){
      $("#insert").click(function(){
            ...
            $.post("saveGoodsCategory",{catId:$("#catId").val(),catName:$("#catName").val(),sort:$("#sort").val(),description:$("#description").val(),isOffline:$("input[name='status']:checked").val()})
...
<legend>类别管理</legend>
<table width="544"  align="center" cellpadding="3" cellspacing="3" id="goodsCategory">
  <td><input id="catId" value="${goodsCategory.catId}" style="display:none;"/></td>
  <tr>
    <td width="87" align="right" >分类名称:</td>
  ...
  <tr>
    <td width="87" align="right" >描述:</td>
    <td width="421" align="right"><input id="description" type="text" name="Input3" value="${goodsCategory.description}" /></td>
  </tr>
