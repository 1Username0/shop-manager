      ...
      $("#insert").click(function(){
        $("#advpic").ajaxSubmit({
          success:function(url){
            $.post("insertadv",{advOrder:$("#advOrder").val(),advTitle:$("#advTitle").val(),advLinkUrl:$("#advLinkUrl").val(),advId:$("#advId").val(),advOffline:$("input[name='status']:checked").val(),advPicUrl:url});
          }
        })
      })
    })
...
<table width="544"  align="center" cellpadding="3" cellspacing="3" id="pic">
  <tr>
    ...
    <td width="421" align="right"><input id="advId" type="text" name="Input0" value="${adv.advId}" /></td>
  </tr>
  <tr>
  ...
  <tr>
    <td width="87" align="right" >广告排序:</td>
    <td width="421" align="right"><input id="advOrder" type="text" name="Input" value="${adv.advOrder}" /></td>
  </tr>
  <tr>
