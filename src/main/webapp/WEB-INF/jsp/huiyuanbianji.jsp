      ...
      $("#insert").click(function(){
        $("#mempic").ajaxSubmit({
          success:function(url){
            $.post("savemem",{memberMobile:$("#memberMobile").val(),memberName:$("#memberName").val(),memberId:$("#memberId").val(),memberPic:url,memberEmail:$("#memberEmail").val(),isSell:$("input[name='status']:checked").val(),memberState:$("input[name='status1']:checked").val()})
          }
        });
      })
    })
...
<table width="544"  align="center" cellpadding="3" cellspacing="3" id="member">
  <td><input id="memberId" value="${mem.memberId}" style="display:none;"/></td>
  <tr>
  ...
  <tr>
    ...
    <td width="421" align="right"><input id="memberEmail" type="text" name="Input3" value="${mem.memberEmail}" /></td>
  </tr>
  <tr>
    ...
    <td align="right">
      ...
      <label id="file_pic">
      <input id="memberPic" value="${mem.memberPic}" type="file" name="f" style="display: none;" />
      <img src="${mem.memberPic}" width="400" height="150" >
      </label>
        </form>
    </td>
  </tr>
